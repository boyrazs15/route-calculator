...
public class ApiResponseBuilder {
    ...
    public static <T> ResponseEntity<ApiSuccessResponse<T>> success(T data) {
        ApiSuccessResponse<T> success = ApiSuccessResponse.<T>builder()
                .success(true)
                .data(data)
                .build();
    ...
    public static ResponseEntity<ApiErrorResponse> error(ErrorCode code, HttpStatus status, String msg, Object data) {
